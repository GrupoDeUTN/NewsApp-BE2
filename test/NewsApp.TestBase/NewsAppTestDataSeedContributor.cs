...
{
    private readonly IRepository<ThemeEntidad, int> _themeRepository;
    ...
    public NewsAppTestDataSeedContributor(IRepository<ThemeEntidad, int> themeRepository, IdentityUserManager identityUserManager,
    ...
    public async Task SeedAsync(DataSeedContext context)
    {
        ...
        //TEMAS
        //Guardamos los temas y forzamos el guardado en la BD antes de insertar noticias

        var theme1 = await _themeRepository.InsertAsync(new ThemeEntidad
        {
            Name = "Primer tema",
            User = identityUser1,
            UserId = identityUser1.Id
        ...
        var theme2 = await _themeRepository.InsertAsync(new ThemeEntidad
        {
            Name = "Segundo tema",
            User = identityUser1,
            UserId = identityUser1.Id
        });
        var theme3 = await _themeRepository.InsertAsync(new ThemeEntidad
        {
            Name = "Tercer tema",
            User = identityUser1,
            UserId = identityUser1.Id
        ...
        //NOTICIAS
        //Ahora que los temas existen en la BD, podemos insertar noticias con ThemeId válido

        var new1 = await _newRepository.InsertAsync(new NewsEntidad
        {
